...
(1, 'Free-Range eggs (Large 6-pack)', '[INSERT DESCRIPTION HERE] ', 'GHF', 'assets/images/eggs.jpg', 'A picture of eggs sitting in a wire basket with straw, feathers and more eggs in the background ', 2.99, 13),
...
(10, 'Roast Chicken (Whole)', '[INSERT DESCRIPTION HERE]', 'CFN', 'assets/images/chicken.jpg', 'A roasted Chickrn on a black platter with roasted tomatoes, aubergine and lemon', 8.99, 10);
...
--
ALTER TABLE `basket`
  MODIFY `basket_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
...
--
ALTER TABLE `user_audit`
  MODIFY `audit_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=223;
