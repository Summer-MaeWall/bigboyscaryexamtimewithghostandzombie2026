<?php
    ...
    echo "<html lang='en'>";
        ...
        echo "<body>";
            ...
            $points = implode(display_loyalty(dbconn_select(), $_SESSION['user'])); //gets the users loyalty points and implodes them into a string

            echo "<p> You have <b>" . $points . "</b> loyalty points</p>"; //displays loyalty points to the user
